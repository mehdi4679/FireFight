<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtlUser.ascx.cs" Inherits="FireFight.Controls.CtlUser" %>
<div>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" OnSorting="GridView1_Sorting"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="SemeatName" HeaderText="سمت" SortExpression="SemeatName" />
