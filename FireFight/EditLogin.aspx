<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/WizardRMenu.Master" AutoEventWireup="true" CodeBehind="EditLogin.aspx.cs" Inherits="FireFight.EditLogin" %>
                                    ...
                                    <div class="widget-main">
                                        <h4 class="header blue lighter bigger">
                                            <i class="ace-icon fa fa-coffee green"></i>
                                             لطفا   شماره داوطلبی و سریال 12 رقمی خرید الکترونیک ثبت نام را وارد کنید
                                        </h4>
