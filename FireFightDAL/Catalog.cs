...
namespace FireFightDAL
{
    public class CatalogClass
    {
        ...
        //---------------------------------------------------------------------------------------------------------
        public static DataSet GetList(ClCatalog c)
        {
        ...
        public static DataSet GetListLevel(int catalogtypeID, int PersonalID)
        {

            SqlCommand cmd = new SqlCommand("PRC_Catalog_GetListEducationLevel", cnn);
            cmd.CommandType = System.Data.CommandType.StoredProcedure;


            cmd.Parameters.Add(new SqlParameter("CatalogTypeID", SqlDbType.NVarChar)).Value = catalogtypeID;
        ...
        public static DataSet GetList2(ClCatalog c)
        {
  ...
  public static int Default(string  CaID)
        ...
        public static DataSet GetListAllAttach(int PersonalID)
        {
           
           
            SqlCommand cmd = new SqlCommand("PRC_Catalog_GetListAllAttach", cnn);
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        public static DataSet GetListAllowCity(int PersonalID)
        {


            SqlCommand cmd = new SqlCommand("PRC_Catalog_GetListAlowCity", cnn);
            cmd.CommandType = System.Data.CommandType.StoredProcedure;
